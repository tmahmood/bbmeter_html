...
GraphCore.prototype.SimpleLine1= function(_data, me) {
    ...
    chart.xAxis.tickValues([1354286240000,1364740640000,1367332640000,1375281440000,1383230240000,1385822240000,1391179040000,1398851067000]) //note: using epoch time = milliseconds since 1/1/1970
        .tickFormat(function(d) { return d3.time.format('%m/%y')(new Date(d))} )
        .axisLabel('Month / Year');

    chart.x2Axis.tickValues([1354286240000,1364740640000,1367332640000,1375281440000,1383230240000,1385822240000,1391179040000,1398851067000])
        .tickFormat(function(d) {return d3.time.format('%m/%y')(new Date(d))});
...
GraphCore.prototype.SimpleLine2= function(_data, me) {
	...
	nv.addGraph(function() {
	  var chart = nv.models.lineWithFocusChart()
		...
		chart.x2Axis
	 .tickValues([1354286240000,1364740640000,1367332640000,1375281440000,1383230240000,1385822240000,1391179040000,1398851067000]) //note: using epoch time = milliseconds since 1/1/1970
			.tickFormat(function(d) {
			return d3.time.format('%m/%y')(new Date(d))
			  });
