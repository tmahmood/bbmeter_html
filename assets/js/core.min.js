...
Presenter.prototype.prepearePresentation = function() {
	...
	var nl = createElement( { element: 'a', id: this.getID('nextSlide'), class: 'slidechange next', attr: { 'href': '#' }, text: '' });
	var pl = createElement( { element: 'a', id: this.getID('prevSlide'), class: 'slidechange prev', attr: { 'href': '#' }, text: '' });
...
Presenter.prototype.drawCurrentSlide = function(hdata, i) {
	...
	if (hdata['img'] != undefined) {
		$(dv).append(createElement({ element: 'img', attr: { src: 'assets/imgs/' + hdata['img']  }}));
	}

	if (hdata['bg'] != undefined) {
		$(dv).css({ background: hdata['bg'] });
	}
